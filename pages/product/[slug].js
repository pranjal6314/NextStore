        ...
        <div className="container px-5 py-16 mx-auto">
          <div className="lg:w-4/5 mx-auto flex flex-wrap">
            <img
              ...
              src="https://m.media-amazon.com/images/I/512s8o2H6bL._UX425_.jpg"
            />
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
              ...
              <div className="flex mt-6 items-center pb-5 border-b-2 border-gray-100 mb-5">
                ...
                <div className="flex ml-6 items-center">
                  ...
                  <div className="relative">
                    <select className="rounded border appearance-none border-gray-300 py-2 focus:outline-none focus:ring-2 focus:ring-sky-200 focus:border-sky-500 text-base pl-3 pr-10">
                      <option>SM</option>
                      <option>M</option>
                      <option>L</option>
                      <option>XL</option>
              ...
              <div className="flex">
                ...
                <button
                  onClick={() => {
                    addToCart(slug, 1, 59, "tshirt", "XL", "white");
                  }}
                  className="flex ml-14 text-white bg-sky-500 border-0 py-2 px-6 focus:outline-none hover:bg-sky-600 rounded"
                >
                  Add to Cart
                </button>
